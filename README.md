...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=16&duration=2000&pause=600&color=C9D1D9&left=true&vCenter=true&width=600&lines=🌏+Chennai%2C+India+🇮🇳;🎯+Flutter+·+Dart+·+Web;💡+Build+→+Optimize+→+Improve+→+Repeat;🎓+CS+Student+@+SRM+IST+Vadapalani;🤖+AI+Engineering+·+Agentic+AI;📱+Mobile+App+Dev+·+Fintech+·+Frontend;🌱+Open+Source+Contributor;⚡+State-level+Taekwondo+Player+🥋;📣+LinkedIn+Creator+·+15k%2B+Impressions+🚀" alt="About Me" />
---
...
|---|---|---|
| [💰 Smart-Interest-X](https://github.com/rmagdaleena2508-01/Smart-Interest-X) | Production-style fintech app for interest & borrower tracking | Flutter · Dart |
| [📊 Student Grade Tracker](https://github.com/rmagdaleena2508-01/Student-grade-tracker) | Clean mobile app demonstrating core Flutter patterns | Flutter |
...
- 📚 Deepening knowledge in async Dart & mobile architecture
- 🌱 Exploring open source contributions (GSSoC)
- ⚡ Always optimizing — code, workflow, and everything in between

---

<div align="center">

*"I'm the kind of person who loves to build, optimize, and improve — not just in programming, but in everyday life."*

![Profile Views](https://komarev.com/ghpvc/?username=rmagdaleena2508-01&color=1D9E75&style=flat-square)
